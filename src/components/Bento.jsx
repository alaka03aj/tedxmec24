const Bento = () => {
  return (
    <>
      <div className="grid w-full grid-cols-3 grid-rows-3 xl:grid-cols-3 xl:grid-rows-3 pt-14 px-4 gap-2 xl:gap-5 xl:pt-24 xl:pb-10 xl:px-16 md:mt-10">
        ...
        <div className="row-span-2 col-span-3 bg-black xl:row-span-2 xl:col-span-1 border-primary-red border-2 rounded-xl flex flex-1 bg-[url('/theme.png')] bg-cover bg-center"></div>
        ...
        <div className="text-4xl xl:text-6xl p-4 items-center text-center font-semibold font-helvetica text-primary-red row-span-1 col-span-3 xl:row-span-2 xl:col-span-1 border-primary-red border-2 rounded-xl flex flex-1 bg-black justify-center hover:bg-primary-red hover:text-black">
          <a href="https://maps.app.goo.gl/n9TgH1dCaHxVbCnS9">
            ATHULYA HALL, INFOPARK
          </a>
        </div>
