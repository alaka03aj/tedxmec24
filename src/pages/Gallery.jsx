    ...
    <div className="scroll-smooth overflow-hidden">
      <div className="w-full md:pt-10 md:pb-10 px-4 md:px-16 justify-between">
        <div className=" text-secondary-white2 pt-[5rem]">
            <h1 className="font-bold font-helvetica text-[36px] text-center text-transparent bg-clip-text bg-gradient-to-r from-white to-secondary-black2 sm:text-5xl">Gallery</h1>
            {/* <div>
